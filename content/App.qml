...
Window {
    ...
    Row {
        ...
        y: 880
        height: 200
        anchors.left: toolsRow.left
        anchors.right: toolsRow.right
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    FlipItem {
                        ...
                        timer.onTriggered: {
                            newWindow.min = clockItem.minutes
                            newWindow.sec = clockItem.seconds
                        }
